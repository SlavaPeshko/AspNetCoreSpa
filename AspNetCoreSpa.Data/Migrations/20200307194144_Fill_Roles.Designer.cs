...
namespace AspNetCoreSpa.Data.Migrations
{
    ...
    [Migration("20200307194144_Fill_Roles")]
    partial class Fill_Roles
    {
            ...
            modelBuilder.Entity("AspNetCoreSpa.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8ede10e9-4443-47a9-b342-e58b485d461f"),
                            RoleEnum = 0,
                            RoleName = "User"
                        },
                        new
                        {
                            Id = new Guid("ad45d8db-07f6-4b03-adb9-169c21e8682d"),
                            RoleEnum = 1,
                            RoleName = "Admin"
                        });
                });
