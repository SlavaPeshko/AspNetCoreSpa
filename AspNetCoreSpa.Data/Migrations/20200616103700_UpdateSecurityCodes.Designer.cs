...
namespace AspNetCoreSpa.Data.Migrations
{
    ...
    [Migration("20200616103700_UpdateSecurityCodes")]
    partial class UpdateSecurityCodes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AspNetCoreSpa.Domain.Entities.PostImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AspNetCoreSpa.Domain.Entities.UserImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AspNetCoreSpa.Domain.Entities.UserImage", b =>
                {
                    b.HasOne("AspNetCoreSpa.Domain.Entities.User", "User")
                        .WithOne("UserImage")
                        .HasForeignKey("AspNetCoreSpa.Domain.Entities.UserImage", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
